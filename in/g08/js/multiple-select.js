  ...
  function () {
    ...
    _createClass(MultipleSelect, [{
      ...
      value: function open() {
        ...
        // 청년정책 추가
        this.$choice.parent().parent().find(".custom_label").addClass("active");
      ...
      value: function close() {
        ...
        // 청년정책 추가
        if(this.$choice.parent(".ms-parent").find("li").hasClass("selected")){
          console.log("있다")
        } else{
          this.$choice.parent().parent().find(".custom_label").removeClass("active");
          console.log("없다")
        }
